  ...
  deleteUser(event) {
    ...
    console.log(this.state.user._id)
      ...
      .then(res => {
        ...
        {
        	if(res.data[i].id_of_prod == this.state.user._id && res.data[i].status != "Canceled")
        	{
	            var userUpdate = res.data[i];
	            userUpdate.status = "Dispatched";
        ...
        this.state.user.status = "Dispatched";
                ...
                <div className="row">
                  ...
                  <div className="row" style={{marginLeft: "0px"}}>
                    <form onSubmit={this.deleteUser}>
                      <button type="submit" className="btn btn-danger" style={{marginLeft: "10px"}}>Dispatch</button>
                    </form>
                  </div> 
